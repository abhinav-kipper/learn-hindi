...
const CHAI_DARK = '#7d4226' // @design-allow: chai liquid darker band
    ...
    <div style={{ width: size, height: size * 1.2, position: "relative", ...style }}>
      <svg viewBox="0 0 120 144" width="100%" height="100%" style={{ overflow: "visible" }}>
        ...
        <g style={{ transformOrigin: "40px 30px", animation: "float-y 2.6s ease-in-out infinite" }}>
          <path d="M 32 24 Q 36 14, 44 18 Q 50 22, 44 30" stroke={W} strokeWidth="6" fill="none" strokeLinecap="round" opacity="0.85" />
        ...
        <g style={{ transformOrigin: "78px 30px", animation: "float-y 2.6s ease-in-out 0.4s infinite" }}>
          <path d="M 88 24 Q 84 14, 76 18 Q 70 22, 76 30" stroke={W} strokeWidth="6" fill="none" strokeLinecap="round" opacity="0.85" />
        ...
        {/* chai liquid */}
        <path d="M 28 44 L 30 60 L 90 60 L 92 44 Z" fill={CHAI_LIQUID} />
        <ellipse cx="60" cy="44" rx="32" ry="3.5" fill={CHAI_DARK} />

        {/* shine */}
        <path d="M 32 50 L 34 110" stroke={W} strokeWidth="3" strokeLinecap="round" opacity="0.7" />
        ...
        {sleepy ? (
          ...
          <>
            <g transform="translate(46 82)">
              ...
              <path d="M 0 -4 L 1 -1 L 4 0 L 1 1 L 0 4 L -1 1 L -4 0 L -1 -1 Z" fill={W} />
            </g>
          ...
          <>
            <g style={{ transformOrigin: "46px 82px", animation: blink ? "blink 5.2s ease-in-out infinite" : "none" }}>
              ...
              <circle cx="48" cy="80" r="2.2" fill={W} />
            </g>
          ...
          <>
            <g style={{ transformOrigin: "46px 82px", animation: blink ? "blink 5.2s ease-in-out infinite" : "none" }}>
              <ellipse cx="46" cy="82" rx="6" ry="8" fill={COLORS.ink} />
              <circle cx="48" cy="80" r="2.2" fill={W} />
              <circle cx="45" cy="85" r="1.2" fill={W} />
            </g>
            <g style={{ transformOrigin: "74px 82px", animation: blink ? "blink 5.2s ease-in-out infinite" : "none" }}>
              ...
              <circle cx="76" cy="80" r="2.2" fill={W} />
              <circle cx="73" cy="85" r="1.2" fill={W} />
            </g>
            {wave && (
              <>
